...
<li class="nav-item nav-dropdown">
    ...
    <ul class="nav-dropdown-items">
        ...
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('page') }}'><i class='nav-icon la la-file-o'></i> <span> Edit page content</span></a></li>
    </ul>
</li>
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="la la-bed nav-icon"></i> Room settings</a>
    <ul class="nav-dropdown-items">
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('document') }}'><i class="las la-passport pr-2"></i> <span> Documents</span></a></li>