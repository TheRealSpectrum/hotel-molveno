...
@section("content")
<main>
  <div class="flex flex-col md:flex-row w-full justify-center m-4 pb-32 md:pb-40 md:pt-12">
    @if (auth()->user()->guest)
    ...
    @else
    <div class="w-full md:w-2/6" id="account-update-container">
    ...
    <div class="pb-4 px-4 w-full md:w-3/6 flex flex-col">
      <h1 class="text-center mb-10 font-medium capitalize text-2xl">Your Reservations</h1>
      <div class="-my-2 sm:-mx-6 lg:-mx-8">
        <div class="py-2 align-middle inline-block w-full md:max-w-4xl sm:px-6 lg:px-8">
          <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <table class="flex flex-col w-full md:min-w-full divide-y divide-gray-200">
