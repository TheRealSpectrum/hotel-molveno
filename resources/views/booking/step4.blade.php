...
<main>
  <div class="w-full flex justify-center">
    ...
    <div class="flex justify-center">
      <div class="border-t border-r border-l  border-gray-200 w-full md:max-w-xl md:mt-8">
        <dl>
          ...
          <div class="bg-gray-50 px-2 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            @if (isset($packageNames))
              @foreach ($packageNames as $packages => $amount)
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  {{ ($packages !== 0) ? $packages : "No packages selected" }}
                </dd>
                <dt class="text-sm font-medium text-gray-500">
    ...
    <form action="{{ route("booking.confirm") }}" method="POST">
      ...
      @if (!\Session::has("success"))
      <div class="flex justify-center">
        <div class="px-4 py-3 bg-gray-50 text-center md:text-right sm:px-6 w-full md:max-w-xl border border-gray-200">
